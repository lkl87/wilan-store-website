...
(function () {
    ...
    function renderLoginBox() {
        ...
        box.innerHTML = `
            ...
            <h3>تسجيل الدخول</h3>
            <p class="sub">سجلي دخولك بحساب تيليجرام لمتابعة طلباتك وحالتها بأي وقت</p>
            <div class="wilan-tg-widget-holder" id="wilanTgWidgetHolder"></div>
            <button class="wilan-guest-btn" onclick="window.__wilanAuthClose()">أو تابعي الشراء بدون تسجيل دخول</button>
        `;
        loadTelegramWidget();
    }
